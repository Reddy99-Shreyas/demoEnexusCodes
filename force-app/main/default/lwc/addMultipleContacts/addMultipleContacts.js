...
import GENDER_IDENTITY from '@salesforce/schema/Contact.GenderIdentity';
...
export default class AddMultipleContacts extends LightningElement {
    ...
    @wire(getPicklistValues, {recordTypeId: '$contactObjectInfo.data.defaultRecordTypeId', fieldApiName: GENDER_IDENTITY})
